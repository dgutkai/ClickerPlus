...
// 只能在编码开始前调用一次
JNIEXPORT void Java_com_qcymall_clickerpluslibrary_adpcm_AdpcmUtils_adpcmReset(
        JNIEnv *env,
        jobject obj){
    adpcmState.index = 0;
...
JNIEXPORT jint Java_com_qcymall_clickerpluslibrary_adpcm_AdpcmUtils_adpcmCoder(
        JNIEnv *env,
...
JNIEXPORT jint Java_com_qcymall_clickerpluslibrary_adpcm_AdpcmUtils_adpcmDecoder(
        JNIEnv *env,
        jobject obj, jbyteArray indata, jbyteArray outdata, jint len){
...
JNIEXPORT jint Java_com_qcymall_clickerpluslibrary_adpcm_AdpcmUtils_add(
        JNIEnv *env,
        jobject obj, jint a1, jint a2){
